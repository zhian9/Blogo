    ...
    "definitions": {
        ...
        "schema.Article": {
            ...
            "properties": {
                ...
                "slug": {
                    "description": "SEO友好URL路径（如 go-concurrency-patterns）",
                    "type": "string"
                },
                "status": {
        ...
        "schema.ArticleForm": {
            ...
            "properties": {
                ...
                "published_at": {
                    "description": "发布时间（可为空，发布时自动设为 now）",
                    "type": "string"
                },
                "seo_desc": {
                    "description": "SEO描述",
        ...
        "schema.Comment": {
            ...
            "properties": {
                ...
                "status": {
                    "description": "评论状态（approved/pending/rejected）",
                    "type": "string"
                },
                "updated_at": {
                    "description": "更新时间",
                ...
                "user": {
                    "description": "关联字段（非数据库字段，用于 API 返回）",
                    "allOf": [
                        {
                            "$ref": "#/definitions/schema.User"
                        }
