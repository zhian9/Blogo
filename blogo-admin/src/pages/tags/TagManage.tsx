...
import { Table, Button, Space, Popconfirm, Modal, Form, Input, message, Typography } from 'antd'
import { PlusOutlined, DeleteOutlined, EditOutlined } from '@ant-design/icons'
import { useGetTagsQuery, useCreateTagMutation, useUpdateTagMutation, useDeleteTagMutation } from '../../store/api'
...
export default function TagManage() {
  ...
  const { data, isLoading } = useGetTagsQuery(params)
