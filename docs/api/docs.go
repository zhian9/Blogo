...
const docTemplate = `{
    ...
    "info": {
        ...
        "contact": {
            "name": "李星云 (lxy911)",
            "url": "https://github.com/zhian9",
            "email": "lxyaa911@gmail.com"
        },
        "license": {
            "name": "MIT",
            "url": "https://github.com/zhian9/Blogo/blob/master/LICENSE"
        },
        "version": "{{.Version}}"
    },
    "host": "{{.Host}}",
    ...
    "paths": {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/schema.ArchiveItem"
                                            }
                                        }
                                    }
                                }
        ...
        "/api/v1/articles": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Article title (fuzzy)",
                        "name": "title",
                        "in": "query"
                    },
                    {
                    ...
                    {
                        "type": "string",
                        "description": "Published at \u003e= (YYYY-MM-DD)",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/schema.BatchUpdateStatusForm"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/categories": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Category name (fuzzy)",
                        "name": "name",
                        "in": "query"
                    }
                ],
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/schema.CategoryForm"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/friend-links": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Friend link name (fuzzy)",
                        "name": "name",
                        "in": "query"
                    },
                    {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/schema.FriendLink"
                                            }
                                        }
                                    }
                                }
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Friend link form",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/schema.FriendLinkForm"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/schema.ImageForm"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/schema.BatchIDsForm"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/images/category/{category}": {
            "get": {
                "tags": [
                    "ImageAPI"
                ],
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/schema.Notification"
                                            }
                                        }
                                    }
                                }
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/schema.OperationLog"
                                            }
                                        }
                                    }
                                }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/schema.PageForm"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/schema.RegisterForm"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/schema.SettingForm"
                        }
                    }
                ],
                "responses": {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/schema.Statistics"
                                            }
                                        }
                                    }
                                }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/schema.TagForm"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        "github_com_zhian9_blogo-server_pkg_errors.Error": {
            "type": "object",
            "properties": {
                "code": {
                ...
                "id": {
                    "description": "错误标识（前端友好）",
                    "type": "string"
                },
                "status": {
                    "description": "状态文本（如 \"Not Found\"）",
                    "type": "string"
                }
            }
        },
        ...
        "schema.Article": {
            ...
            "properties": {
                ...
                "visible_users": {
                    "description": "可见用户列表（手动加载）",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/schema.ArticleVisibleUser"
                    }
                }
            }
        },
        "schema.ArticleForm": {
            ...
            "properties": {
                ...
                "visible_user_ids": {
                    "description": "可见用户ID列表（仅 partial_visible 时使用）",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
        ...
        "schema.Captcha": {
            ...
            "properties": {
                "captcha_id": {
                    "description": "CaptchaID: 验证码唯一标识（用于后续验证）\n前端需在登录时提交此 ID + 用户输入的验证码",
                    "type": "string",
        ...
        "schema.Comment": {
            ...
            "properties": {
                ...
                "ip": {
                    "description": "评论者IP（IPv4/IPv6）",
                    "type": "string"
                },
                "is_top": {
                    "description": "是否置顶（管理员可置顶优质评论）",
                    "type": "boolean"
                },
                "moderation_message": {
                    "description": "审核提示",
                ...
                "parent_id": {
                    "description": "父评论ID（用于回复评论，实现嵌套）",
                    "type": "string"
                },
                "status": {
                    "description": "评论状态（pending→审核后approved/rejected）",
                    "type": "string"
                },
                "updated_at": {
                    "description": "更新时间",
                ...
                "user": {
                    "description": "关联字段（全部手动加载，避免外键约束）",
                    "allOf": [
                        {
                            "$ref": "#/definitions/schema.User"
                        }
                ...
                "user_id": {
                    "description": "评论者ID（可为空，支持游客评论）",
                    "type": "string"
                },
                "username": {
                    "description": "评论者名称（若为游客，则存储输入的名称）",
                    "type": "string"
                }
            }
        },
        "schema.CommentForm": {
            ...
            "properties": {
                ...
                "user_id": {
                    "description": "已登录用户ID（由 token 解析，前端不应传）",
                    "type": "string"
                },
                "username": {
                    "description": "游客需填名称",
        ...
        "schema.FriendLink": {
            ...
            "properties": {
                ...
                "logo": {
                    "description": "Logo图片URL（可关联 Image 表）",
                    "type": "string"
                },
                "name": {
                    "description": "站点名称",
        ...
        "schema.Image": {
            ...
            "properties": {
                "category": {
                    "description": "分类（如 \"article_cover\", \"ad_image\", \"friend_link_logo\"）",
                    "type": "string"
                },
                "created_at": {
                    "description": "上传时间",
                ...
                "name": {
                    "description": "原始文件名（如 architecture-diagram.png）",
                    "type": "string"
                },
                "path": {
                    "description": "存储路径（如 /uploads/2025/10/xxx.png）",
                    "type": "string"
                },
                "size": {
                    "description": "文件大小（字节）",
                ...
                "url": {
                    "description": "图片访问URL（如 https://cdn.example.com/xxx.png）",
                    "type": "string"
                },
                "width": {
                    "description": "图片宽度（像素）",
        ...
        "schema.Logger": {
            ...
            "properties": {
                "created_at": {
                    "description": "创建时间（索引，用于时间范围查询）",
                    "type": "string"
                },
                "data": {
                    "description": "其他结构化字段的 JSON 序列化结果（TEXT 类型）",
                    "type": "string"
                },
                "id": {
                    "description": "唯一 ID（主键，20 字符）",
                    "type": "string"
                },
                "level": {
                    "description": "日志级别（索引，便于查询）",
                    "type": "string"
                },
                "login_name": {
                    "description": "LoginName: 关联用户的登录名（来自 User.Username）\ngorm:\"\u003c-:false\" 表示禁止写入数据库\ngorm:\"-:migration\" 表示迁移时忽略此字段",
                    "type": "string"
                },
                "message": {
                    "description": "日志主消息（最多 1024 字符）",
                    "type": "string"
                },
                "stack": {
                    "description": "错误堆栈（TEXT 类型，存储长文本）",
                    "type": "string"
                },
                "tag": {
                    "description": "日志分类标签（索引，如 \"login\", \"system\"）",
                    "type": "string"
                },
                "trace_id": {
                    "description": "链路追踪 ID（索引，用于排查问题）",
                    "type": "string"
                },
                "user_id": {
                    "description": "操作用户 ID（索引，用于审计）",
                    "type": "string"
                },
                "user_name": {
                    "description": "UserName: 关联用户的真实姓名（来自 User.Name）",
                    "type": "string"
                }
            }
        },
        "schema.LoginForm": {
            ...
            "properties": {
                "captcha_code": {
                    "description": "CaptchaCode: 用户输入的验证码（必填）\n前端从验证码图片中识别的字符\nExample: aB3x9",
                    "type": "string",
                    "example": "aB3x9"
                },
                "captcha_id": {
                    "description": "CaptchaID: 验证码 ID（必填）\n来自 Captcha 接口的 captcha_id\nExample: 6ba7b810-9dad-11d1-80b4-00c04fd430c8",
                    "type": "string",
                    "example": "6ba7b810-9dad-11d1-80b4-00c04fd430c8"
                },
                "password": {
                    "description": "Password: 登录密码（必填）\nExample: blogo123456",
                    "type": "string",
                    "example": "blogo123456"
                },
                "username": {
                    "description": "Username: 登录用户名（必填）\nExample: admin",
                    "type": "string",
                    "example": "admin"
                }
            }
        ...
        "schema.Menu": {
            ...
            "properties": {
                ...
                "parent_id": {
                    "description": "父菜单 ID（根菜单为空）",
                    "type": "string"
                },
                "parent_path": {
                    "description": "父菜单路径（如 \"root.parent\"，用于快速查询祖先）",
                    "type": "string"
                },
                "path": {
                    "description": "访问路径（前端路由或 API 路径）",
                    "type": "string"
                },
                "properties": {
                    "description": "扩展属性（JSON 格式，如 {\"icon\": \"user\", \"hidden\": true}）",
                    "type": "string"
                },
                "resources": {
                    "description": "关联的资源列表（API 路径+方法，用于 Casbin 权限）",
                    "type": "array",
                    "items": {
        ...
        "schema.MenuForm": {
            ...
            "properties": {
                ...
                "status": {
                    "description": "状态（必填，enabled/disabled）",
                    "type": "string",
                    "enum": [
                        "disabled",
                        "enabled"
                ...
                "type": {
                    "description": "菜单类型（必填，page/button）",
                    "type": "string",
                    "enum": [
                        "page",
                        "button"
        ...
        "schema.MenuResource": {
            ...
            "properties": {
                ...
                "menu_id": {
                    "description": "关联的菜单 ID（外键，指向 menu.id）",
                    "type": "string"
                },
                "method": {
        ...
        "schema.OperationLog": {
            ...
            "properties": {
                "action_type": {
                    "description": "操作类型（如：新增、编辑、删除、审核）",
                    "type": "string"
                },
                "created_at": {
                    "description": "时间戳",
        ...
        "schema.RegisterForm": {
            ...
            "properties": {
                "captcha_code": {
                    "description": "CaptchaCode: 验证码输入（必填）\nExample: xK9m2",
                    "type": "string",
                    "example": "xK9m2"
                },
                "captcha_id": {
                ...
                "confirm_password": {
                    "description": "ConfirmPassword: 二次确认密码（必填）\nExample: MyPass123!",
                    "type": "string",
                    "maxLength": 64,
                    "example": "MyPass123!"
                },
                "email": {
                    "description": "Email: 邮箱（必填，合法格式）\nExample: user2025@example.com",
                    "type": "string",
                    "maxLength": 128,
                    "example": "user2025@example.com"
                },
        ...
        "schema.RoleMenu": {
            ...
            "properties": {
                "created_at": {
                    "description": "创建时间 / Create timestamp",
                    "type": "string"
                },
                "id": {
                    "description": "唯一标识符 / Unique identifier",
                    "type": "string"
                },
                "menu_id": {
                    "description": "菜单ID，来自Menu表的ID / Menu ID, from Menu.ID",
                    "type": "string"
                },
                "role_id": {
                    "description": "角色ID，来自Role表的ID / Role ID, from Role.ID",
                    "type": "string"
                },
                "updated_at": {
                    "description": "更新时间 / Update timestamp",
                    "type": "string"
                }
            }
        },
        ...
        "schema.UpdateCurrentUser": {
            ...
            "properties": {
                "avatar": {
                    "description": "Avatar: 头像 URL（可选，最大 512 字符）\nExample: https://example.com/avatar.jpg",
                    "type": "string",
                    "maxLength": 512,
                    "example": "https://example.com/avatar.jpg"
                },
                "bio": {
                    "description": "Bio: 个人简介/个性签名（可选，最大 512 字符）\nExample: 全栈开发者，热爱开源",
                    "type": "string",
                    "maxLength": 512,
                    "example": "全栈开发者，热爱开源"
                },
                "email": {
                    "description": "Email: 邮箱地址（可选，最大 128 字符）\nExample: lxy911@gmail.com",
                    "type": "string",
                    "maxLength": 128,
                    "example": "lxy911@gmail.com"
                },
                "name": {
                    "description": "Name: 用户姓名（必填，最大 64 字符）\nExample: 李星云",
                    "type": "string",
                    "maxLength": 64,
                    "example": "李星云"
                },
                "phone": {
                    "description": "Phone: 手机号码（可选，最大 32 字符）\nExample: +8613800138000",
                    "type": "string",
                    "maxLength": 32,
                    "example": "+8613800138000"
                },
                "remark": {
                    "description": "Remark: 备注信息（可选，最大 1024 字符）\nExample: 开发者",
                    "type": "string",
                    "maxLength": 1024,
                    "example": "开发者"
                }
        ...
        "schema.UpdateLoginPassword": {
            ...
            "properties": {
                "new_password": {
                    "description": "NewPassword: 新密码\nExample: newSecurePass!2025",
                    "type": "string",
                    "example": "newSecurePass!2025"
                },
                "old_password": {
                    "description": "OldPassword: 旧密码\n用于验证用户身份\nExample: oldPass123",
                    "type": "string",
                    "example": "oldPass123"
                }
            }
        ...
        "schema.User": {
            ...
            "properties": {
                ...
                "bio": {
                    "description": "Bio / personal signature",
                    "type": "string"
                },
                "created_at": {
                    "description": "Create time",
                ...
                "last_login_ip": {
                    "description": "Last login IP (supports IPv6)",
                    "type": "string"
                },
                "name": {
                    "description": "Name of user",
                ...
                "status": {
                    "description": "Status of user (activated, inactive, freezed)",
                    "type": "string"
                },
                "updated_at": {
                    "description": "Update time",
        ...
        "util.ResponseResult": {
            ...
            "properties": {
                "data": {},
                "error": {
                    "$ref": "#/definitions/github_com_zhian9_blogo-server_pkg_errors.Error"
                },
                "success": {
                    "type": "boolean"
                },
